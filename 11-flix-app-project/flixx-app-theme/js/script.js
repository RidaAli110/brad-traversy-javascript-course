...
const global = {
  ...
  api: {
    // Only use this key for development or very small projects. You should store your key and make requests from server
    apiKey: '9845c998380f98087e43647a19bc08b3',
...
async function displaySlider() {
  ...
  results.forEach((movie) => {
    ...
    sliderDiv.innerHTML = `<a href="movie-details.html?id=${movie.id}">
...
async function searchAPIdata() {
  ...
  const response = await fetch(
    `${API_URL}search/${global.search.type}?api_key=${API_KEY}&language=en-us
